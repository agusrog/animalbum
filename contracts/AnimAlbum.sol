...
contract AnimAlbum is ERC1155, Ownable {
    ...
    function uri(uint256 _tokenid) override public pure returns (string memory) {
        return string(abi.encodePacked("https://azure-renewed-dog-869.mypinata.cloud/ipfs/QmYfPtXauVLGZki9rs1gfZLxGHpaJi76R7TXydFzFtctS6/", Strings.toString(_tokenid),".json"));
    }
